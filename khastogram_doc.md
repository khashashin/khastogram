...
## Ruby on Rails | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
## ORM | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
## Namenskonventionen in Ruby On Rails | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
##### Allgemeine Regeln | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
##### Datenbank | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
```
    ...
    +------------+-------------+        | firma_id       | FOREIGN KEY |
                                        ...
                                        +---------------------+--------+
```
##### Model (Klassen) | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
```
##### Beziehungen in Modellen | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
```
##### Controller | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
##### Routen | [Inhaltsverzeichnis](#inhaltsverzeichnis)
...
##### Views | [Inhaltsverzeichnis](#inhaltsverzeichnis)
